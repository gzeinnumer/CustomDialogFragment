package com.gzeinnumer.customdialogfragment.dialog.confirmDialog;
...
public class ConfirmDialogSetting extends BaseDialog {
    ...
    protected Button _dBtnCancelMBT;
    protected Button _dBtnCancelMBO;
    protected Button _dBtnCancelMBC;
